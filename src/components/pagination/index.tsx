      ...
      {paginationItems.map((item, index) => {
        ...
        return item === "..." ? (
          ...
          <button
            ...
            className={`px-3 py-1 rounded border text-sm font-medium ${item === currentPage ? "bg-blue-600 text-white border-blue-600" : "text-gray-700 border-gray-300 hover:bg-gray-100"}`}
          >
            {item}
          </button>
        );
